    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-md border-t border-border safe-area-bottom">
      <div className="max-w-2xl mx-auto px-4 py-2">
        <div className="flex items-center justify-around">
          ...
          {/* Theme Toggle */}
          <div className="flex flex-col items-center gap-1 h-auto py-3 px-4">
            <ThemeToggle />
          ...
          <Button
            size="sm"
            className="flex flex-col items-center gap-1 h-auto py-3 px-4 rounded-xl bg-soft-primary text-text-primary hover:bg-soft-primary/80 shadow-lg"
          >
