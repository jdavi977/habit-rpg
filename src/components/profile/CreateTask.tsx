...
const CreateTask = ({ userId }: { userId: string }) => {
    ...
    const difficultyLevels = [
      { name: "Easy", color: "from-green-500/20 to-green-600/10", borderColor: "border-green-500/30", textColor: "text-white-400" },
      { name: "Medium", color: "from-yellow-500/20 to-yellow-600/10", borderColor: "border-yellow-500/30", textColor: "text-white-400" },
      { name: "Hard", color: "from-red-500/20 to-red-600/10", borderColor: "border-red-500/30", textColor: "text-white-400" }
    ];
         ...
         {title && difficulty && days.length > 0 && (
           <div className="text-center p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-green-600/5 border border-green-500/20">
             <p className="text-green-400 text-sm font-medium">
               Ready to create: <span className="text-green-300">{title}</span>
             </p>
