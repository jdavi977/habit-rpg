  ...
  return (
    <div className="w-full md:py-2 lg:py-2 relative">
      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        ...
        <div className="bg-cyber-terminal-bg/50 backdrop-blur-sm border border-cyber-line-color rounded-xl overflow-hidden mb-12 md:mb-16 lg:mb-20 shadow-lg shadow-cyber-glow-primary/10">
          {/* ENHANCED HEADER BAR */}
          ...
          <div className="p-6 md:p-8 lg:p-10 text-center">
            <div className="flex items-center justify-center gap-3 mb-6 md:mb-8">
              <div className="w-1 h-6 md:h-8 bg-cyber-blue-bright rounded-full animate-pulse"></div>
            ...
            <div className="bg-cyber-terminal-bg/30 border border-cyber-line-color rounded-lg p-4 md:p-6 max-w-2xl mx-auto mb-8 md:mb-10">
              <p className="text-base md:text-lg text-cyber-text-bright leading-relaxed">
        ...
        <div className="text-center pt-12 md:pt-16 lg:pt-20 mb-8 md:mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 gap-y-8 md:gap-y-12">
        ...
        <div className="mt-12 md:mt-16 lg:mt-20 text-center">
          <div className="relative inline-block group">
            ...
            <Link href="/home">
              <Button
                size="lg"
                className="relative bg-gradient-to-r from-cyber-blue-bright text-cyber-dark hover:from-cyber-blue to-cyber-blue-bright px-8 md:px-10 py-4 md:py-6 text-base md:text-lg font-bold font-mono transition-all duration-300 hover:shadow-lg hover:shadow-cyber-glow-strong/30 hover:scale-105"
              >
                <Shield className="mr-2 md:mr-3 h-5 w-5 md:h-6 md:w-6" />
                Start Questing Now
                <Swords className="ml-2 md:ml-3 h-5 w-5 md:h-6 md:w-6" />
              </Button>
            </Link>
          </div>
          <div className="mt-4 md:mt-6 flex items-center justify-center gap-2">
            ...
            <p className="text-cyber-text-muted font-mono text-base md:text-lg">
